...
locations:[
{id:'HN-BB-042',lat:21.003,lng:105.821,img:'../../assets/ooh/hanoi-133-stkm.jpg',name:'Ngã tư Sở, Hà Nội',type:'Billboard',city:'Hà Nội',size:'8×12m',priceN:45,status:'available',
...
{id:'HN-AP-011',lat:21.214,lng:105.803,img:'../../assets/ooh/noibai-41b.jpg',name:'Nội Bài T2, băng chuyền đến',type:'Sân bay',city:'Hà Nội',size:'6×4m',priceN:60,status:'available',
...
{id:'HN-LED-007',lat:21.016,lng:105.779,img:'../../assets/ooh/hanoi-cg01-nct.png',name:'LED Phạm Hùng, Hà Nội',type:'LED',city:'Hà Nội',size:'10×6m',priceN:40,status:'soon',
...
{id:'SG-BB-118',lat:10.801,lng:106.711,img:'../../assets/ooh/phapvan-19a.png',name:'Cầu vượt Hàng Xanh, TP.HCM',type:'Billboard',city:'TP.HCM',size:'12×8m',priceN:55,status:'available',
...
{id:'SG-AP-023',lat:10.813,lng:106.664,img:'../../assets/ooh/vungtau-sgvt.jpg',name:'Tân Sơn Nhất, sảnh quốc nội',type:'Sân bay',city:'TP.HCM',size:'5×3m',priceN:58,status:'available',
...
{id:'DN-PN-031',lat:16.061,lng:108.245,img:'../../assets/ooh/quangninh-hl16.jpg',name:'Pano Võ Nguyên Giáp, Đà Nẵng',type:'Pano',city:'Đà Nẵng',size:'6×9m',priceN:32,status:'booked',
...
news:[
{img:'../../assets/ooh/bacninh-10b.png',date:'02.07.2026',tag:'Hệ thống vị trí',title:'Toàn Cầu mở rộng hệ thống LED tại trục Phạm Hùng',excerpt:'Bổ sung 4 màn hình LED mới tại khu văn phòng phía Tây Hà Nội, khai thác từ quý 3/2026.'},
{img:'../../assets/ooh/phapvan-19a.png',date:'18.06.2026',tag:'Sản phẩm số',title:'Ra mắt bản đồ vị trí OOH tra cứu trực tuyến',excerpt:'Khách hàng tự khám phá vị trí, xem điểm AI theo ngành hàng và tạo báo giá PDF trong vài phút.'},
{img:'../../assets/ooh/quangninh-hl16.jpg',date:'05.06.2026',tag:'Hợp tác',title:'Hợp tác quảng cáo tại nhà chờ xe bus 5 tỉnh thành',excerpt:'Mạng lưới nhà chờ mở rộng tại Hà Nội, TP.HCM, Đà Nẵng, Cần Thơ và Nghệ An.'},
{img:'../../assets/ooh/phapvan-51a.png',date:'22.05.2026',tag:'Thị trường OOH',title:'Xu hướng OOH 2026: dữ liệu vị trí và điểm phù hợp ngành hàng',excerpt:'Quảng cáo ngoài trời chuyển dịch sang mô hình chọn vị trí theo dữ liệu lưu lượng và tệp khách.'},
{img:'../../assets/ooh/noibai-41b.jpg',date:'10.05.2026',tag:'Hệ thống vị trí',title:'Bổ sung 12 mặt biển tại nhà ga T2 Nội Bài',excerpt:'Các vị trí băng chuyền và sảnh đến quốc tế sẵn sàng khai thác từ tháng 6.'},
{img:'../../assets/ooh/noibai-24a1.jpg',date:'28.04.2026',tag:'Hợp tác',title:'Đồng hành cùng hãng hàng không trong chiến dịch hè 2026',excerpt:'Chuỗi vị trí sân bay hai miền phục vụ chiến dịch quảng bá đường bay mới.'}],
cases:[{img:'../../assets/ooh/haiphong-caurao2.jpg',brand:'Nhãn hàng F&B',industry:'F&B',result:'Phủ 12 billboard nội đô Hà Nội'},{img:'../../assets/ooh/noibai-24a1.jpg',brand:'Hãng hàng không',industry:'Hàng không',result:'Chuỗi vị trí sân bay 2 miền'},{img:'../../assets/ooh/quangninh-hl30.jpg',brand:'Thương hiệu điện tử',industry:'Điện tử',result:'LED giờ vàng trục văn phòng'}]
};
